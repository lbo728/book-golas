...
import 'package:book_golas/ui/core/ui/custom_snackbar.dart';
import 'package:book_golas/ui/core/ui/keyboard_accessory_bar.dart';
...
class _BookDetailScreenState extends State<BookDetailScreen>
  ...
  void _showTodayGoalSheet() {
    TodayGoalSheet.show(
      context: context,
      initialStartPage: _todayStartPage,
      initialTargetPage: _todayTargetPage,
      onSave: (start, end) {
        setState(() {
